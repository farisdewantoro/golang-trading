...
VALUES(7, '📈 Stock Position Monitoring', 'Menganalisis posisi saham pengguna secara berkala dan memberikan notifikasi jika diperlukan tindakan, seperti take profit, cut loss, atau menyesuaikan stop loss.', 'stock_position_monitor', '{"exchange":"IDX","max_concurrency":5}'::jsonb, '{"max_retries": 0, "backoff_strategy": "string", "initial_interval": "string"}'::jsonb, 1800, '2025-06-24 13:16:48.057', '2025-06-24 13:16:48.057');
INSERT INTO public.jobs
(id, "name", description, "type", payload, retry_policy, timeout, created_at, updated_at)
VALUES(4, '🚨 Stock Price Alert', 'Mengirim peringatan ke Telegram saat harga saham mencapai batas yang telah ditentukan (TP/SL).
', 'stock_price_alert', '{"data_range":"1d","data_interval":"1m","alert_cache_duration":"30m","exchange":"IDX","alert_resend_threshold_percent":2}'::jsonb, '{"max_retries": 0, "backoff_strategy": "string", "initial_interval": "string"}'::jsonb, 360, '2025-06-17 20:44:35.326', '2025-06-17 20:44:35.326');
INSERT INTO public.jobs
(id, "name", description, "type", payload, retry_policy, timeout, created_at, updated_at)
